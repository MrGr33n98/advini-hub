...
import { Scale, Eye, EyeOff, LogIn, Shield } from "lucide-react";
...
export default function LoginPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    setLoading(false);
    setError("Funcionalidade de login em breve. Plataforma em fase beta.");
  };
        ...
        <div className="z-10 relative">
          ...
          >
            <p className="text-2xl font-display font-semibold leading-relaxed mb-6">
              "A justiça não é uma recompensa que os bons recebem,<br />
              é um direito que todos merecem."
            </p>
            <footer className="text-white/50 text-sm">— Princípio do Acesso à Justiça</footer>
          </motion.blockquote>
        </div>

        <div className="grid grid-cols-3 gap-4 z-10 relative">
          {[
            { label: "+10.000", desc: "Advogados" },
            { label: "98%", desc: "Satisfação" },
            { label: "+50k", desc: "Clientes atendidos" },
          ].map(stat => (
      ...
      <div className="flex-1 flex items-center justify-center p-6 sm:p-12">
        ...
        >
          <Link href="/" className="flex items-center gap-2 mb-10 lg:hidden">
            ...
            <span className="font-bold text-xl text-foreground">Advocacia<span className="text-primary">Hub</span></span>
          </Link>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            <div className="space-y-1.5">
              ...
              <Input
                ...
                className="h-12 rounded-xl bg-muted/50 border-border/50 focus:bg-white"
                autoComplete="email"
              />
            </div>
            ...
            <div className="space-y-1.5">
              ...
              <div className="relative">
                <Input
                  ...
                  className="h-12 rounded-xl bg-muted/50 border-border/50 focus:bg-white pr-12"
            ...
            <Button variant="outline" type="button" className="w-full h-12 rounded-xl text-base border-border/50 hover:bg-muted/50">
          ...
          <div className="flex items-center justify-center gap-1.5 mt-6 text-xs text-muted-foreground/60">
            ...
            Plataforma segura com criptografia SSL
          </div>
        </motion.div>
      </div>
    </div>
